...
contract TestingToken is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable {
    using Counters for Counters.Counter;
    uint256 MAX_SUPPLY = 10;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Testing Token", "TTK") {}

    function safeMint(address to, string memory uri) public {
        uint256 tokenId = _tokenIdCounter.current();
        require(tokenId <= MAX_SUPPLY, "I'm sorry, all NFT's have been minted. Better luck next time!");
